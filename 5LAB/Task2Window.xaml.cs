...
namespace _5LAB
{
    ...
    public partial class Task2Window : Window
    {
        ...
        {
            MessageBox.Show("Разработчик: Воронин Г.А.\nГруппа: АСОИ-221\nЛабораторная работа №5 — WPF Стили", "О разработчике", MessageBoxButton.OK, MessageBoxImage.Information);
        }
        ...
        private void UIElement_MouseEnter(object sender, MouseEventArgs e)
        {
            ...
            else if (sender is Button && (sender as Button).Content.ToString().Contains("Назад"))
            {
                hint = "Вернуться к главному меню";
            }
